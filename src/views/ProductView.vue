<template>
  <v-container v-if="product">
    ...
    <v-row>
      ...
      <v-col cols="12" md="6">
        ...
        <v-btn color="secondary" variant="outlined" size="large" prepend-icon="mdi-credit-card" @click="buyNow" block>
          Comprar Agora
        </v-btn>
      </v-col>
    </v-row>
  ...
  <v-container v-else>
    <v-alert type="error" class="mb-4"> Produto não encontrado </v-alert>

    <v-btn @click="$router.push('/')" color="primary"> Voltar à loja </v-btn>
  </v-container>
</template>
