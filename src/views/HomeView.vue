    ...
    <section id="products-section" class="products-section" ref="productsSection">
      <v-container class="py-16">
          ...
          <v-col cols="12">
            <div class="controls-container">
              <div class="filter-container">
                <v-chip-group v-model="activeTab" color="primary" selected-class="text-primary font-weight-bold"
                  mandatory class="filter-chips">
              ...
              <div class="sort-container">
                <v-select v-model="sortBy" :items="sortItems" label="Ordenar" variant="solo-filled" density="compact"
                  color="primary" hide-details class="sort-select"
        ...
        <v-row>
          ...
          <v-col v-for="product in productsStore.filteredProducts" :key="product.id" cols="12" sm="6" md="4" lg="3">
