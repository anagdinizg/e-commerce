        ...
        <div class="form-group">
          <div class="input-row">
            <div class="input-field">
              <input v-model="form.nome" type="text" placeholder="Nome completo" class="minimal-input"
                :class="{ error: errors.nome }" @blur="validateSingleField('nome')" aria-describedby="nome-error" />

              <span v-if="errors.nome" id="nome-error" class="error-message" role="alert">{{
                errors.nome
                }}</span>
            </div>
            ...
            <div class="input-field">
              <input v-model="form.email" type="email" placeholder="E-mail" class="minimal-input"
                :class="{ error: errors.email }" @blur="validateSingleField('email')" @input="handleEmailInput"
          ...
          <div class="input-field">
            <input v-model="form.telefone" type="tel" placeholder="Telefone" class="minimal-input"
              :class="{ error: errors.telefone }" @input="handleTelefoneInput" @blur="validateSingleField('telefone')"
        ...
        <div class="form-group">
          <div class="input-row">
            <div class="input-field cep-field">
              <input ref="cepInput" v-model="form.cep" type="text" placeholder="CEP" class="minimal-input"
                :class="{ error: errors.cep, loading: loadingCep }" @input="handleCepInput" @blur="validateCepFormat"
                maxlength="9" aria-describedby="cep-status cep-error" />
              ...
              <span v-if="errors.cep" id="cep-error" class="error-message" role="alert">{{
                errors.cep
                }}</span>
            </div>
          ...
          <div class="input-row">
            <div class="input-field number-field">
              <input ref="numeroInput" v-model="form.numero" type="text" placeholder="Número" class="minimal-input"
                :class="{ error: errors.numero }" @blur="validateSingleField('numero')"
            ...
            <div class="input-field">
              <input v-model="form.complemento" type="text" placeholder="Complemento (opcional)" class="minimal-input"
                @blur="validateSingleField('complemento')" />
            </div>
          </div>
          ...
          <div class="input-row">
            <div class="input-field">
              <input v-model="form.bairro" type="text" placeholder="Bairro" class="minimal-input"
                :class="{ error: errors.bairro }" :readonly="addressReadonly" @blur="validateSingleField('bairro')"
            ...
            <div class="input-field">
              <input v-model="form.cidade" type="text" placeholder="Cidade" class="minimal-input"
                :class="{ error: errors.cidade }" :readonly="addressReadonly" @blur="validateSingleField('cidade')"
            ...
            <div class="input-field uf-field">
              <input v-model="form.uf" type="text" placeholder="UF" class="minimal-input" :class="{ error: errors.uf }"
                :readonly="addressReadonly" maxlength="2" @input="handleUfInput" @blur="validateSingleField('uf')"
                aria-describedby="uf-error" />

              <span v-if="errors.uf" id="uf-error" class="error-message" role="alert">{{
                errors.uf
                }}</span>
            </div>
          </div>
