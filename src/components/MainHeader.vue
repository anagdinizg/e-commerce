<template>
  <header class="main-header">
    <div class="header-container">
      ...
      <div class="header-actions desktop-actions">
        <nav class="nav-menu">
          ...
          <button class="nav-link" @click="$router.push('/about')" :class="{ active: $route.name === 'about' }">
            Sobre
          </button>
        </nav>

        <button class="cart-btn" @click="cartStore.toggleDrawer()" :class="{ 'has-items': cartStore.totalItems > 0 }">
    ...
    <nav class="mobile-menu" :class="{ active: showMobileMenu }">
      ...
      <button class="mobile-nav-link" @click="navigateToProducts">
    ...
    <div class="mobile-overlay" :class="{ active: showMobileMenu || showMobileSearch }" @click="closeAllMobileMenus">
    </div>
  </header>
</template>
